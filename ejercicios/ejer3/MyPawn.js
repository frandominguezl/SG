...
class MyPawn extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    var geo = new THREE.LatheGeometry(this.points, this.guiControls.resolucion, 0, this.guiControls.angulo);
    // Como material se crea uno a partir de un color
    var material = new THREE.MeshNormalMaterial();
    
    // Ya podemos construir el Mesh
    this.latheObject = new THREE.Mesh(geo, material);
    ...
    this.latheObject.position.y = 1.4;
