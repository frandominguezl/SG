...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    // Creamos el objeto por revolución
    this.latheObject = new MyPawn(this.gui, "Parámetros de Revolución");
  ...
  createGUI () {
    ...
    folder.add (this.guiControls, 'flatShading').name ('Sombreado plano')
      .onChange(function(check){
        that.latheObject.material.flatShading(check);
        that.latheObject.material.needsUpdate(true);
      });
